...
Kugle is a mobile game that we developed with a bunch of friends, offering a unique 3D experience on mobile devices.
...
I am responsible for the development and maintenance of the vast majority of the backend services, including the API,
the game server management system, the databases and the blockchain integration (the smart contracts).

The technologies used are Node.js, TypeScript, MongoDB and Solidity.
